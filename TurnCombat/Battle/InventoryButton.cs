...
{
    /// <summary>
    /// Handles what happens when you press an inventory button
    /// </summary>
    public partial class InventoryButton : Button
    {
        ...
        public static Action OnInventoryButtonPressed;
        ...
        {
            DescriptionsPlayer.SetDescription(_slot.Item.ItemDescription);
        }
        ...
        public void OnButtonDown()
        {
            if(_slot.Amount <= 0)
            {
                ...
                Text = $"{_slot.Item.ItemName} x{_slot.Amount}";
                DescriptionsPlayer.SetDescription("Out of stock");
